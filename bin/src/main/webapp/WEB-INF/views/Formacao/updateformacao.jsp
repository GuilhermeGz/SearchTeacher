...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Formação -->
			<li class="nav-item"><a class="nav-link" href="/formacao/"> <i
					class="fas fa fa-graduation-cap"></i> <span>Formacao</span>
			</a></li>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<form:form method="POST" modelAttribute="formacaoForm"
								...
								<br>
								<a href="#" data-toggle="modal" data-target="#cadastrarFormacao"
									class="btn btn-primary btn-icon-split" type="submit"> <span
