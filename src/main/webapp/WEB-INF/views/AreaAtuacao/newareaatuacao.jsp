		...
		<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
			<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
				...
				<head>
					...
					<title>Cadastrar área de formação</title>
					<meta charset="UTF-8">
						...
						<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="background-image: url('../../resources/index/assets/img/bg-masthead.jpg')" id="accordionSidebar">
							...
							<li class="nav-item"><a class="nav-link collapsed" href="#" data-toggle="collapse"
									data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"> <i
										class="fas fa-fw fa-cog"></i> <span>Configuracões</span>
								</a>
								...
								<div class="container-fluid">
									...
									<div class="card shadow mb-4">
										<div class="card-title ml-4	mt-4">
											<h4>Cadastrar Área de Atuação</h4>
										</div>
										...
										<div class="card-body">
											...
											<form:form method="POST" modelAttribute="areaAtuacaoForm"
												action="/areaatuacao/new2">
												...
												<a type="button"class="btn btn-primary" href="/areaatuacao">
