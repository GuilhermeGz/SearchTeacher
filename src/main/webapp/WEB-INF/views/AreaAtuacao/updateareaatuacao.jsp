			...
			<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
				...
				<body id="page-top">
					...
					<div id="wrapper">
						...
						<!-- Sidebar -->
						<ul class="navbar-nav sidebar sidebar-dark accordion" style="background-image: url('../../resources/index/assets/img/bg-masthead.jpg')" id="accordionSidebar">
