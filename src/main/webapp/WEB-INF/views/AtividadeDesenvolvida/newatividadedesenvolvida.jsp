        ...
        <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                ...
                <head>
                    ...
                    <title>Cadastrar atividade Desenvolvida</title>
                    <meta charset="UTF-8">
                ...
                <body id="page-top">
                    ...
                    <div id="wrapper">
                        ...
                        <!-- Sidebar -->
                        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="background-image: url('../../resources/index/assets/img/bg-masthead.jpg')" id="accordionSidebar">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-title ml-4	mt-4">
                                            <h4>Cadastrar Atividade Desenvolvida</h4>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form:form method="POST" modelAttribute="atividadeDesenvolvidaForm"
                                                action="/atividadedesenvolvida/new2">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <form:input path="dataFim" cssClass="form-control"
                                                                type="date" />
                                                            <form:errors path="dataFim"></form:errors>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <a type="button"class="btn btn-primary" href="/atividadedesenvolvida">
