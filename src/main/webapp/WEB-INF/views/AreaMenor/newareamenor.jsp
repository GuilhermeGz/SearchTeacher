								...
								<div class="container-fluid">
									...
									<div class="card shadow mb-4">
										...
										<div class="card-body">
											...
											<form:form method="POST" modelAttribute="areaMenorForm"
												action="/areamenor/new2">
												...
												<a type="button"class="btn btn-primary" href="/areamenor">
